      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.profileCard, { backgroundColor: colors.cardBg, borderColor: colors.borderColor }]}>
          ...
          <Text style={[styles.profileType, { color: colors.textGray }]}>
            {user?.tipo_conta || 'Professor'}
          </Text>
        </View>

        <View style={styles.statsRow}>
          {[
            { value: '0', label: 'Perguntas criadas' },
            { value: '0', label: 'Respostas dadas' },
            { value: '0%', label: '% de acertos' },
          ].map((s, i) => (
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.cardBg }]}>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity style={[styles.modalBtn, { backgroundColor: colors.error }]} onPress={handleExcluir}>
